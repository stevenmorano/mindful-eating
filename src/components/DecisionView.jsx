...
export default function DecisionView({ onEat, onSkip, onExtend, canEatSnack }) {
        ...
        return (
            <div className="view decision-view" style={{ justifyContent: 'center', textAlign: 'center', alignItems: 'center' }}>
                ...
                <div style={{ background: 'var(--mm-bg-surface)', border: '1px solid var(--mm-border)', padding: '32px', borderRadius: '16px', marginBottom: '40px', width: '100%', maxWidth: '400px' }}>
                    <h3 style={{ marginBottom: '8px', color: 'var(--mm-accent-primary)' }}>{snackSuggestion.category}</h3>
                    <h2>{snackSuggestion.text}</h2>
                </div>

                <button type="button" className="mm-btn primary-solid" onClick={onEat} style={{ width: '100%', maxWidth: '300px' }}>
                    Done
                </button>
            </div>
        );
        ...
        return (
            <div className="view decision-view" style={{ justifyContent: 'center', textAlign: 'center', alignItems: 'center' }}>
                <div style={{ marginBottom: '60px', width: '100%' }}>
                    ...
                    <p style={{ fontSize: '16px', maxWidth: '80%', margin: '0 auto' }}>Before we grab a snack, let's complete one more distraction. Often cravings pass after 10 minutes.</p>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', width: '100%', maxWidth: '400px' }}>
                    <div style={{ background: 'var(--mm-bg-surface)', border: '1px solid var(--mm-border)', padding: '24px', borderRadius: '16px' }}>
                        <button type="button" className="mm-btn primary-solid" onClick={onExtend} style={{ width: '100%', marginBottom: '12px' }}>
    ...
    return (
        <div className="view decision-view" style={{ justifyContent: 'center', textAlign: 'center', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', width: '100%' }}>
                <div style={{ background: 'var(--mm-bg-surface)', border: '1px solid var(--mm-border)', padding: '24px', borderRadius: '16px' }}>
                    <button type="button" className="mm-btn primary-solid" onClick={handlePassed} style={{ width: '100%', marginBottom: '12px' }}>
                        The craving passed!
                    </button>
                    <p style={{ fontSize: '13px' }}>
                ...
                <div style={{ padding: '0 24px' }}>
                    <button type="button" className="mm-btn" onClick={handleStillHungry} style={{ width: '100%', marginBottom: '12px', borderColor: 'transparent', boxShadow: 'var(--shadow-sm)' }}>
                        I still want to eat
                    </button>
                    <p style={{ fontSize: '13px' }}>
                        {canEatSnack ? "That's okay. Let's choose a mindful option." : "That's okay. One more pause comes first."}
                    </p>
                </div>
            </div>
        </div>
